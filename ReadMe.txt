...
Pour utiliser le fichier, telechargez libgdx, puis crées un projet (nommé ici "test").
...
Enfin, il devrait rester une unique erreur dans DesktopLauncherjava, il suffit de cliquer droit sur l'erreur et cliquer sur le fix.
